...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configuration/master/_listings/akamai/config-media-live-v1-api-live-utils-archivelocation-get.md
x-common:
- type: x-base
