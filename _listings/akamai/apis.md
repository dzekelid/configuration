...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configuration/master/_listings/akamai/config-media-security-v1-security-policyid-environment-get.md
x-common:
- type: x-base
