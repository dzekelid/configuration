...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/configuration/master/_listings/akamai/config-gtm-v1-domains-domain-datacenters-datacenterid-delete.md
x-common:
- type: x-base
